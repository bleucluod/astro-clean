...
assert(reportDetail.includes("آسمان امروز"), "ReportDetail must expose the personal transit tab label.");
assert(reportDetail.includes("v0.1.269-live-report-personal-transit"), "ReportDetail missing v0.1.269 personal transit marker.");
...
assert(projectContext.includes("Personal transit is now live in ReportDetail"), "Project context must record personal transit live status.");
