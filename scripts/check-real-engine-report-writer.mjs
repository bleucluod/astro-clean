...
for (const marker of [
  ...
  "buildCorePlacementText(sun, \"sun\", realEngineWithAspects)",
  "buildCorePlacementText(moon, \"moon\", realEngineWithAspects)",
  "buildRisingText(",
  ...
  "buildOptionalPlacementText(mercury, \"mercury\", realEngineWithAspects)",
  "buildOptionalPlacementText(venus, \"venus\", realEngineWithAspects)",
  "buildOptionalPlacementText(mars, \"mars\", realEngineWithAspects)",
