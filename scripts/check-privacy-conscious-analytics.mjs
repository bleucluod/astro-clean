...
requireText("analytics component", analyticsComponent, "analyticsWindow.dataLayer?.push(arguments);");
forbidText("analytics component", analyticsComponent, "analyticsWindow.dataLayer?.push(args);");
forbidText("analytics component", analyticsComponent, "analyticsWindow.gtag = (...args:");
