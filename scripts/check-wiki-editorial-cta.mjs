...
const required = [
  ...
  ["components/AppShell.tsx", ["HALLEUS_WIKI_CTA_RUNTIME_V18", "HALLEUS_WIKI_CTA_MOTION_POLISH_V21", "void card.offsetHeight;", 'data-wiki-chrome-control="back-to-top"', 'const revealProgress = 0.35;', 'const visibleDurationMs = 12000;', 'const exitDurationMs = 300;', 'const minSafeViewportHeight = 320;', 'new IntersectionObserver', "visibilitychange", "data-wiki-card-active", "data-wiki-end-cta-in-view", "pointerdown", "focusin", "prefers-reduced-motion: reduce"]],
...
for (const token of [".editorialMobileCta[hidden]", "display: none !important;", "HALLEUS_WIKI_EDITORIAL_MOBILE_CTA_POLISH_V21", "background: rgba(11, 13, 17, 0.97);", "color: #f4f6f8;", "border: 1px solid rgba(255, 255, 255, 0.14);", "border-radius: 16px;", "box-shadow: 0 14px 34px rgba(0, 0, 0, 0.28);", "width: min(352px, calc(100vw - 28px));", "max-height: min(188px, 34dvh);", "background: #e4e8ed;", "color: #11141a !important;", "min-height: 48px;", "width: 40px;", "height: 40px;", "background: conic-gradient(", "#d8dde5 92% 97%", "mask-composite: exclude;", ".editorialMobileCta[data-state=\"visible\"]", ".editorialMobileCta[data-tab-visible=\"false\"]"]) {
