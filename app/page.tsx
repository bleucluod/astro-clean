...
export const metadata: Metadata = {
  ...
  description:
    "Halleus چارت تولد را به یک گزارش فارسی، انسانی و قابل مرور تبدیل می‌کند و آسمان امروز را با ماه اکنون، فاز ماه و ترنزیت روزانه تهران نشان می‌دهد.",
  alternates: {
    canonical: "/",
  },
};
...
const howItWorks = [
  ...
  },
  {
    ...
    description:
      "در صفحه اصلی، آسمان امروز با ماه اکنون، فاز ماه و جنبه‌های واقعی ترنزیت روزانه تهران تازه می‌شود.",
  },
  {
    icon: "↶",
...
const trustCards = [
  ...
  },
  {
    ...
    description:
      "در وضعیت فعلی گزارش‌ها عمومی و قابل پیدا شدن در گوگل نیستند. هر مدل انتشار عمومی بعداً باید با رضایت روشن کاربر طراحی شود.",
  },
];

const currentFocusItems = [
  {
    title: "گزارش تولد خواندنی‌تر",
    description:
      "تمرکز اصلی هالیوس روی خوانش تولد فارسی، واضح و قابل برگشت است؛ نه اضافه‌کردن وعده‌های شلوغ قبل از کامل شدن گزارش.",
  },
  {
    title: "حریم گزارش‌ها",
    description:
      "گزارش شخصی بدون انتخاب روشن تو عمومی نمی‌شود. هر مسیر انتشار باید شفاف، قابل فهم و قابل برگشت باشد.",
  },
  {
    title: "محتوای فارسی در خدمت گزارش",
    description:
      "محتوا باید کمک کند گزارش تولد بهتر فهمیده شود؛ نه اینکه سایت را با بخش‌های زودهنگام و کم‌ارزش شلوغ کند.",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "نه. هالیوس از چارت تولد و زبان نمادین آسترولوژی برای خودشناسی استفاده می‌کند. نبض امروز هم خوانش عمومی آسمان امروز و ترنزیت روزانه تهران است، نه پیش‌بینی قطعی.",
  },
  {
    question: "نبض آسمان امروز بر اساس کجاست؟",
    answer:
      "فعلاً با زمان و افق تهران تنظیم می‌شود و خروجی عمومی/sky-only است. انتخاب شهرهای دیگر و خوانش شخصی نسبت به چارت تولد بعداً جداگانه اضافه می‌شود.",
  },
  {
    question: "آیا گزارش من عمومی یا قابل پیدا شدن در گوگل می‌شود؟",
    answer:
  ...
  return (
    <section className="homepage-redesign" data-page="home">
      <section className="home-app-hero" aria-labelledby="home-hero-title">
        <div className="home-hero-copy">
          ...
          <p className="hero-lede">
            ...
            رابطه‌ها، مسیر رشد و ریتم درونی‌ات. کنار آن، آسمان امروز هم با ماه
            اکنون، فاز ماه و ترنزیت روزانه تهران تازه می‌شود.
          </p>
      ...
      <section className="home-two-column-row">
        ...
        <section className="home-section home-path-card" aria-labelledby="current-focus">
          <div className="home-section-heading compact">
            <div>
              <span className="section-label">تمرکز فعلی</span>
              <h2 id="current-focus">هالیوس اول گزارش تولد را کامل‌تر می‌کند</h2>
            </div>
          </div>
