...
export function PremiumRequestForm({
  ...
  return (
    <section className="card manual-order-form">
      ...
      <p>فقط اطلاعات لازم برای پیگیری را وارد کن و دادهٔ پزشکی، مالی یا محرمانهٔ غیرضروری ننویس.</p>
      ...
      <div className="form-grid">
        ...
        <label>
          ...
          <small>انتخاب انتشار از ثبت سفارش جداست و نمایش نام نیز رضایتی جداگانه می‌خواهد.</small>
        </label>
        <label>
          توضیحات
          <textarea
