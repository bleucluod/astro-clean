  ...
  return (
    ...
    >
      <div className="report-section-heading">
        ...
        <p>
          این بخش آسمان امروز را با چارت تولد تو مقایسه می‌کند: چارت تولد از
          محل تولد و زمان تولد می‌آید، اما ترنزیت شخصی باید با محل زندگی فعلی
          خوانده شود. هالیوس برای گزارش شخصی، تهران را بی‌اجازه جایگزین محل
          فعلی نمی‌کند.
        </p>
      </div>
        ...
        <div className="report-personal-transit-depth">
          <div className="report-section-heading compact">
            ...
            <p>
              ...
              می‌آورد. متن‌ها راهنمای مشاهده‌اند، نه حکم قطعی یا پیش‌گویی.
            </p>
          </div>
...
function buildTransitInsight(aspect: PersonalTransitReportDataBridgeAspectSummary) {
  ...
  return {
    ...
    helpful: `از این تماس برای دیدن واضح‌تر ${natalField} استفاده کن، نه برای قضاوت قطعی درباره خودت یا دیگران.`,
    growth: `اگر این بخش سنگین حس شد، آن را به‌عنوان دعوت به تنظیم ریتم، مرز و انتخاب آگاهانه بخوان؛ نه به‌عنوان اجبار آسمانی.`,
  };
}
