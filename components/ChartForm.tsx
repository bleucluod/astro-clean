          ...
          >
            ...
            <div className="chart-form-fields">
              ...
              <div className="chart-field chart-field-full">
                ...
                {birthTimeMode === "unknown" ? (
                  <small className="field-hint">
                    اگر ساعت دقیق را نمی‌دانی، می‌توانی ادامه بدهی؛ در گزارش مشخص می‌کنیم کدام بخش‌ها به ساعت دقیق وابسته‌اند.
                  </small>
                ) : null}
              ...
              {!comparisonMode ? (
                ...
                />
                <span>
                  <strong>آسمان امروز را روی چارتت ببین</strong>
                  <small>
                    جای سیاره‌های امروز را کنار چارت تولدت می‌گذاریم تا ببینی این روزها کدام بخش‌های چارتت پررنگ‌ترند. محل زندگی فعلی فقط برای همین مقایسه لازم است و به گزارش تولدت اضافه نمی‌شود.
                  </small>
                </span>
              </label>
              ) : null}
