  ...
  return (
    ...
    >
      <div className="report-section-heading">
        ...
        <p>
          این بخش قبل از زاویه‌های سیاره‌ای می‌آید تا اول خودِ جایگاه هر سیاره روشن شود: سیاره در کدام نشان است، در چه خانه‌ای عمل می‌کند و به زبان ساده چه کیفیت‌هایی می‌آورد.
        </p>
      </div>
