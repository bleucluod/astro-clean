...
## User-Facing Copy Detox - Pricing/Order
- Accepted: Pricing and Order should describe the current manual fuller-report path in calm product language, not as payment/backend/storage implementation status.
